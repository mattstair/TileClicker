...
RESOURCES = {
             ...
             'fish': {'image': pygame.image.load('Fish2a.png').convert_alpha(),
                      ...
                      'minegives': {'food': 1},
                      'minecosts': {'energy': 5}},
             'tree': {'image': pygame.image.load('Tree2.png').convert_alpha(),
                      'minetime': 5*ONE_SEC,
                      'minegives': {'wood': 2},
                      'minecosts': {'energy': 5}},
             'bush': {'image': pygame.image.load('Bushb2.png').convert_alpha(),
                      'minetime': 5*ONE_SEC,
                      'minegives': {'food': 1},
                      'minecosts': {'energy': 5}},
             'sand': {'image': pygame.image.load('Sandpile2.png').convert_alpha(),
                      'minetime': ONE_SEC,
                      'minegives': {'sand': 1},
                      'minecosts': {'energy': 5}},
             'treasure': {'image': pygame.image.load('chest.png').convert_alpha(),
                          'minetime': ONE_SEC,
                          'minegives': {'coins': 20},
                          'minecosts': {'energy': 5}},
             'loosegem': {'image': pygame.image.load('Gem2.png').convert_alpha(),
                          'minetime': ONE_SEC,
                          'minegives': {'gem': 1},
                          'minecosts': {'energy': 5}},
             'animal trap': {'image': pygame.image.load('Trap.png').convert_alpha(),
                             'minetime': ONE_SEC,
                             'minegives': {'food': 4},
                             'minecosts': {'energy': 5}},
             'house': {'image': pygame.image.load('House.png').convert_alpha(),
                       'minetime': TEN_SEC,
                       'minegives': {'stone': 10,
                                     'wood': 20},
                       'minecosts': {'energy': 20},
             ...
             'forager hut': {'symbol': "FH",
                             ...
                             'upkeep': {'workers': 1},
                             'frequency': 5*ONE_SEC},
             'lumberjack hut': {'image': pygame.image.load('Choppingblock.png').convert_alpha(),
                                'minetime': 5*ONE_SEC,
                                'minegives': {'stone': 10,
                                              'wood': 20},
                                'minecosts': {'energy': 20},
