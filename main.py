...
RESOURCES = {
             ...
             'golddeposit': {'image': pygame.image.load('gold.png').convert_alpha(),
                             ...
                             'minegives': {'goldore': 2},
                             'minecosts': {'energy': 20}},
             'fish': {'image': pygame.image.load('fish.png').convert_alpha(),
                      'minetime': 5*ONE_SEC,
                      'minegives': {'food': 1},
                      'minecosts': {'energy': 5}},
             'tree': {'image': pygame.image.load('tree.png').convert_alpha(),
                      'minetime': 5*ONE_SEC,
                      'minegives': {'wood': 2},
                      'minecosts': {'energy': 5}},
             'bush': {'image': pygame.image.load('bush.png').convert_alpha(),
                      'minetime': 5*ONE_SEC,
                      'minegives': {'food': 1},
                      'minecosts': {'energy': 5}},
             'sand': {'image': pygame.image.load('sand.png').convert_alpha(),
                      'minetime': ONE_SEC,
                      'minegives': {'sand': 1},
                      'minecosts': {'energy': 5}},
